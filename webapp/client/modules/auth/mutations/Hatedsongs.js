...
function Hatedsongs(environment, input: {release_date:string}) {
    return fetch(`/resources/videos/mostHated?release_date=${encodeURIComponent(input.release_date)}`, {
        method: 'GET',
