...
from views import LoginView, SignUpView, RelevantArtistView, HatedGenreSongView, PopularGenreSongsView, MostPopularSongsView, MostHatedSongView,EqualizerView,LongestArtistSongView,DislikeSongsView
